...
public class Server implements MouseListener{
    ...
    private Label messageLabel, connectionStatusLabel;
    private java.awt.Button yes, no;
    private Dialog dialog;
    private int port;
    private Button resetButton;

    private void createDialogBox() {
	java.awt.Label lbl = new java.awt.Label("Someone wants to connect. Do you allow the connection ?");
	
	dialog = new Dialog(new Frame());
	yes = new java.awt.Button("Yes");
	no = new java.awt.Button("No");
	...
	Panel panel = new Panel(), panelButton = new Panel();
